                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            <div class="form-group">
                                                <label for="sell_status">نوع</label>
                                                <select name="sell_status" class="select2 form-control <?= errorClass('sell_status') ?>">
                                                    <option value="0"  <?= oldOrValue('sell_status', $advertise->sell_status) == 0 ? 'selected' : '' ?>>free</option>
                                                    <option value="1"  <?= oldOrValue('sell_status', $advertise->sell_status) == 1 ? 'selected' : '' ?>>cash</option>
                                                </select>
                                        ...
                                        <fieldset class="form-group">
                                            <div class="form-group">
                                                ...
                                                <select name="type" class="select2 form-control <?= errorClass('type') ?>">
                                                    <option value="0" <?= oldOrValue('type', $advertise->type) == 0 ? 'selected' : '' ?>>بناء</option>
                                                    <option value="1" <?= oldOrValue('type', $advertise->type) == 1 ? 'selected' : '' ?>>متحف</option>
                                                    <option value="2" <?= oldOrValue('type', $advertise->type) == 2 ? 'selected' : '' ?>>منتزه</option>
                                                    <option value="3" <?= oldOrValue('type', $advertise->type) == 3 ? 'selected' : '' ?>>عيادة</option>
                                                </select>
                                                <?= errorText('type') ?>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset class="form-group">
                                            <div class="form-group">
                                                ...
                                                <select name="parking" class="select2 form-control <?= errorClass('parking') ?>">
                                                    <option value="0" <?= oldOrValue('parking', $advertise->parking) == 0 ? 'selected' : '' ?>>لا يوجد</option>
                                                    <option value="1" <?= oldOrValue('parking', $advertise->parking) == 1 ? 'selected' : '' ?>>موجود</option>
                                                </select>
                                                <?= errorText('parking') ?>
                                            </div>
                                        </fieldset>
