            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">الفئة</h4>
                        <span><a href="<?= route('admin.category.create') ?>" class="btn btn-success">خلق</a></span>
                    </div>
                            ...
                            <div class="">
                                <table class="table zero-configuration">
                                    ...
                                    <tr>
                                        ...
                                        <th>اسم</th>
                                        <th>فئة والد</th>
                                        <th style="min-width: 6rem; text-align: left;">الاعدادات</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php foreach ($categories as $category) {?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td style="min-width: 6rem; text-align: left;">
                                                <a href="<?= route('admin.category.edit',[$category->id]) ?>" class="btn btn-info waves-effect waves-light">تصحيح</a>
