...
Route::get('/price', 'HomeController@allPrice', 'home.all.price');
Route::get('/price/{id}', 'HomeController@price', 'home.price');
Route::get('/posts', 'HomeController@allPost', 'home.all.post');
Route::get('/posts/{id}', 'HomeController@post', 'home.post');
...
// price routes
Route::get('/admin/price', 'Admin\PriceController@index', 'admin.price.index');
Route::get('/admin/price/create', 'Admin\PriceController@create', 'admin.price.create');
Route::post('/admin/price/store', 'Admin\PriceController@store', 'admin.price.store');
Route::get('/admin/price/edit/{id}', 'Admin\PriceController@edit', 'admin.price.edit');
Route::put('/admin/price/update/{id}', 'Admin\PriceController@update', 'admin.price.update');
Route::delete('/admin/price/delete/{id}', 'Admin\PriceController@destroy', 'admin.price.delete');
Route::get('/admin/price/gallery/{id}', 'Admin\PriceController@gallery', 'admin.price.gallery');
Route::post('/admin/price/store-gallery-image/{id}', 'Admin\PriceController@storeGalleryImage', 'admin.price.store.gallery.image');
Route::get('/admin/price/delete-gallery-image/{gallery_id}', 'Admin\PriceController@deleteGalleryImage', 'admin.price.delete.gallery.image');
