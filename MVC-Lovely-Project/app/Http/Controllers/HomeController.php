...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $doctorsCount = Ads::orderBy('view', 'desc')->orderBy('created_at', 'desc')->limit(0, 4)->get();
    ...
    {
        $objects = Price::all();
        return view('app.all-price', compact('objects'));
    }
    ...
    public function price($id)
    {
        ...
        $pictures = $object->pictures()->get();
        $posts = Post::where('published_at', '<=', date('Y-m-d H:i:s'))->orderBy('created_at', 'desc')->limit(0, 4)->get();
        // $relatedObjects = Price::where('cat_id', $object->cat_id)->where('id', '!=', $id)->orderBy('created_at', 'desc')->limit(0, 2)->get();
        $categories = Category::all();
        return view('app.price', compact('posts', 'pictures', 'object', 'categories'));
    }
